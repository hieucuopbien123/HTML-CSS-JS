...
//kp là mấy giờ mà là thời gian còn lại là bnh giây. Lưu ý client đang chạy file này
...
//độ trễ giữa client và server và remaining time sẽ ít đi: remainingTime - (thời gian client nhận - thời gian gửi đi)/2
//Đây là thuật toán gần giống với SNTP(Simple Network Time Protocol) là 1 trong các IP protocol để máy tính đồng bộ thời
//gian với server
